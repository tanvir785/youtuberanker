                ...
                <Card>
                    <Card.Content>
                        ...
                        <Statistic>
                            ...
                            <Statistic.Value>{videoDetail.youtubeVideo.items[0].statistics.viewCount}</Statistic.Value>
                        </Statistic>
                        <br />
                        <Statistic>
                            <Statistic.Label>Comment Count</Statistic.Label>
                            <Statistic.Value>{videoDetail.youtubeVideo.items[0].statistics.commentCount}</Statistic.Value>
                        </Statistic>
                    </Card.Content>
                </Card>
            </div>
